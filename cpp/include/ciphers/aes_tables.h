//
// Created by eik on 17.11.19.
//

#ifndef _AES_UTILS_H_
#define _AES_UTILS_H_
...
namespace ciphers {
    ...
    /**
     * Map x => 2 * x in F_{2^8} with (x^8 + x^4 + x^3 + x + 1).
     */
    const uint8_t AES_X2[256] = {
    ...
    /**
     * Map x => 3 * x in F_{2^8} with (x^8 + x^4 + x^3 + x + 1).
     */
    const uint8_t AES_X3[256] = {
    ...
    /**
     * Map x => 2 * S[x] in F_{2^8} with (x^8 + x^4 + x^3 + x + 1).
     */
    const uint8_t AES_X2_SBOX[256] = {
    ...
    /**
     * Map x => 3 * S[x] in F_{2^8} with (x^8 + x^4 + x^3 + x + 1).
     */
    const uint8_t AES_X3_SBOX[256] = {
