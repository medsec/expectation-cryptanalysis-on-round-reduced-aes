...
TEST(Small_AES_PRESENT_SBOX, test_key_schedule) {
...
TEST(Small_AES_PRESENT_SBOX, test_encrypt_6_rounds_only_sbox_in_final_with_aes_ni) {
    const small_aes_key_t key = {
        0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef
    };
    ...
    const __m128i expected_ciphertext = vsetr8(
        0x0f, 0x09, 0x00, 0x04, 0x03, 0x00, 0x0e, 0x0e,
        0x05, 0x0b, 0x0e, 0x0b, 0x0f, 0x0e, 0x0e, 0x04
    );
